    ...
    <div id="app">
        ...
        <aside class="aside" :class="{open:open,docked:docked}" @click="toggle()">
            <ul>
                ...
                <li :class="{chose:num == index+2}" v-for="(item,index) in list" @click="change(index+2,item.id)">
                    <span>{{item.name}}</span>
                    <i class="iconfont" :class="{'iconcolor icon-ic_star_black':num == index+2,'icon-ic_star':num != index+2}"></i>
                </li>
                <li @click="jump()">
                    <span>项目地址</span>
